...
//   const modifyProfile = () => {
//     axios
//     .put(`${import.meta.env.VITE_BACKEND_URL}/user/checkUserExistence`,{
...
//           {isModifying === true ? (
//             <>
//               <input type="text" placeholder="Pseudo" value={connectedUser.username}
//                     onChange={(e) =>
//                       setConnectedUser({ ...connectedUser, [e.target.name]: e.target.value })
//                     }/>
